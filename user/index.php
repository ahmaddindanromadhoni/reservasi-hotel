...
<div class="row">
  <div class="col-lg">
    <div class="card">
      <div class="card-body">
        <form action="pemesanan.php" method="post" name="opsi">
          <div class="row">
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <select name="tipe" id="selek" class="form-control" required="required" onchange="pilih()">
                  ...
                  <?php 
                  $qqq = mysqli_query($koneksi, "SELECT * FROM kamar");
                  while($q = mysqli_fetch_assoc($qqq)){
                  ?>
									<option value="<?= $q['harga']?>"><?= $q['tipe'] ?></option>
                  <?php } ?>
								</select>
              </div>
            </div>
